...
function Footer({ footerNavItems }: FooterProps) {
  ...
  const groupedNavItems = footerNavItems.reduce(
    (acc: GroupedNavItems, item: NavigationItem) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h2 className="text-xl font-bold mb-4">Better Sleep</h2>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300">
            © {currentYear} Better Sleep. All rights reserved.
          </p>
